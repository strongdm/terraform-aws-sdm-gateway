...
# Set the AWS instance name and the StrongDM Node Name
...
# Use the public or private aws DNS hostname as the Strongdm Node Name
...
# Use the automatically generated hostname by the Strongdm platform as a Node Name
